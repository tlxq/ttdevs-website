...
export default function Hero() {
  return (
    <section data-snap className="relative flex min-h-screen items-center justify-center px-4">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-b from-transparent to-[#0F4C75]/60" />

      {/* Ambient blobs */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="tt-blob-primary -top-32 -left-32 h-72 w-72" />
        <div className="tt-blob-secondary right-0 -bottom-40 h-80 w-80" />
        <div className="tt-blob-accent top-1/3 left-1/2 h-64 w-64 -translate-x-1/2" />
      </div>
